...
<div id="logo"></div>
    <section class="row">
        <div class="twelve columns">
          ...
          <section id="threebox">
            <h2>Your trustworthy auto body shop.</h2>
            <p>We believe in helping our customers in any way we can. We hope
              you choose Slick's for any of your auto repair needs. Listed
